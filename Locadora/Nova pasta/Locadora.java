public class Locadora{
	...
	public void alugar(Carro c, int posicao){
		if(c.getEstado==1)
			System.out.println("- - ERRO - -");
		else{
			c.setEstado(1);
			System.out.println("- - Carro_" + posicao + " alugado com sucesso - -");
		}
	}

	public void devolver(Carro c, int posicao){
		if(c.getEstado==0)
			System.out.println("- - ERRO - -");
		else{
			c.setEstado(0);
			System.out.println("- - Carro_" + posicao + " devolvido com sucesso - -");
		}		
	}
